...
const Hero = () => {
    return(
        <section id="about" className="max-w-6xl mx-auto px-6 py-20 md:py-32 flex flex-col md:flex-row items-center justify-between gap-12">
            {/* Left Side: Content */}
            <motion.div
            ...
            <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-slate-400 text-lg max-w-xl leading-relaxed mb-10">
                    ...
                    human-centered products with <span className="text-blue-400">React & TypeScript</span>.
                </p>
                ...
                <button className="px-8 py-3 border border-slate-700 hover:bg-slate-800 text-white font-semibold rounded-lg transition-all">
                    Resume
                </button>
                </div>
            </div>
